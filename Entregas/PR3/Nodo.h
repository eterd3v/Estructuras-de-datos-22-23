...
class Nodo {
public:
    ///Es el dato de tipo T que almacena el Nodo<T>
    T dato;
    ///Es un puntero que indica la posición del anterior Nodo<T>
    Nodo<T>* ant;
    ///Es un puntero que indica la posición del posterior Nodo<T>
    Nodo<T>* sig;
