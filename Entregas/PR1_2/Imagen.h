...
public:
     ...
     * @param id es una cadena de caraceteres que representa el identificador de la imagen
     * @param email es una cadena de caraceteres que representa el email asociado a la imagen
     * @param nombre es una cadena de caraceteres que representa el nombre de la imagen
     * @param tam es un entero positivo asociado al tamaño que ocupa la imagen
     * @param fecha es la Fecha asociada a la imagen
     * @param etiquetas es una cadena de caraceteres que representa las diferentes etiquetas de la imagen
     */
     ...
     * @param orig es la Imagen desde la cual se van a asignar los datos a otra Imagen.
     ...
     * @param orig es la otra Imagen con quien se va a comparar.
     ...
     * @param orig es la otra Imagen con quien se va a realizar la comparación.
