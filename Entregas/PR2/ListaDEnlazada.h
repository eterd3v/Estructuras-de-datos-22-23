...
private:
    Nodo<T>* cabecera;     //// Es un puntero de Nodo<T> que actúa como la cabecera de la lista
    Nodo<T>* cola;         //// Es un puntero de Nodo<T> que actúa como la cola de la lista
    unsigned int tam;      //// Es el tamaño actual de elementos en la ListaDEnlazada<T>
public:
